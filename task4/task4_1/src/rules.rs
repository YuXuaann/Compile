...
lazy_static::lazy_static! {
    pub static ref SYSY: std::sync::Mutex<CFG> = {
        let mut sys_y_grammar = CFG::new();
        let mut make = |lhs, rhs| sys_y_grammar.construct_rule(lhs, rhs);
        ...
        sys_y_grammar.set_start(&CompUnit);
